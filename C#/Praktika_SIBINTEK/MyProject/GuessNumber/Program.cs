...
{
    /// <summary>
    /// Улучшить игры. Сделать более интерактивное меню, с возвратом назад и т.д. Добавить игры.
    /// Разобраться как это сделать используя приватные классы
    /// </summary>

    class Ruletka
    {
        static public void Polosa()
        {
...

    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("3 - Пока толкьо одна игра");
            string s = Console.ReadLine();
            switch (s)
            {
                case "1": GuessNumberr.GuessNumber();
                    break;
                case "2": Ruletka.Game2();
                    break;
                case "3": GuessNumberr.Test();
                    break;
            }
        }
